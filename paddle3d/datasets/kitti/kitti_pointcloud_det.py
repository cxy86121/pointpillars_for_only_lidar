...
class KittiPCDatasetBak(KittiDetDataset):
    """
    """
...
class KittiPCDataset(KittiDetDataset):
    ...
    def __getitem__(self, index: int) -> Sample:
        ...
        if self.is_train_mode:
            ...
            # name truncate occlusion center_x,center_y,center_z,scale_x,scale_y,scale_z,rotation
            #                                                       w       l        h
            lidar_records = kitti_records    # if order need to change or not
            ignored_lidar_records = ignored_kitti_records
            ...
            bboxes_3d, cls_names = kitti_utils.lidar_record_to_object(
                lidar_records)
            ignored_bboxes_3d, _ = kitti_utils.lidar_record_to_object(
                ignored_lidar_records)
